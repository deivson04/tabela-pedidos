...
<div class="form-label">
  ...
  <div class="form-label">
    ...
    <input type="date" value="<?php echo isset($pedidos)?$pedidos->STR_TO_DATE(getDataDoPedido()):""; ?>" name="dataDoPedido" class="form-control" id="dataDoPedido" style="min-width:300px;"  placeholder="Enter Date" required>
  </div>
