...
<div class="form-label">
  ...
  <div class="form-label">
    ...
    <input type="text" value="<?php echo isset($pedido)?$pedido->getNomeDaLoja():""; ?>" name="nomeDaLoja" class="form-control" id="nomeDaLoja" style="min-width:300px;" placeholder="Enter hall" required>
  </div>
  ...
  <div class="form-label">
    ...
    <input type="text" value="<?php echo isset($pedido)?$pedido->getBairroDaLoja():""; ?>" name="bairroDaLoja" class="form-control" id="bairroDaLoja" style="min-width:300px;"  placeholder="Enter Neighborhood" required>
  </div>
